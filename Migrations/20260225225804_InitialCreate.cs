        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationMode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sarah Chen", new DateTime(2026, 2, 11, 14, 30, 0, 0, DateTimeKind.Utc), "I'd love to join! I play midfielder and have experience.", 1, "Accepted" },
                    { 2, "Mike Rodriguez", new DateTime(2026, 2, 11, 15, 0, 0, 0, DateTimeKind.Utc), "Count me in! I'm available on Sunday.", 1, "Accepted" },
                    { 3, "Emily Park", new DateTime(2026, 2, 11, 16, 0, 0, 0, DateTimeKind.Utc), "I'm interested! Can I bring a friend?", 1, "Pending" },
                    { 4, "Jessica Liu", new DateTime(2026, 2, 11, 17, 0, 0, 0, DateTimeKind.Utc), "Would love to join but I'm a beginner. Is that okay?", 1, "Rejected" }
                });
